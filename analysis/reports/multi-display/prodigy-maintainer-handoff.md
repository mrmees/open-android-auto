...
- **Confirmed — 17.3 static:** directly observed in the decompiled 17.3 phone
  code, with exact source anchors preserved in
  [`android-auto-17.3.md`](android-auto-17.3.md).
...
No current Prodigy source tree is present in this repository, so those are
responsibility-level seams rather than promised current filenames. The names
come from the archived milestone-4 architecture and should be mapped onto the
maintainer's current branch.
...
The large JADX tree is intentionally ignored, so the linked 17.3 analysis report
is the permanent review artifact.

### Canonical protocol files

- [`ChannelDescriptorData.proto`](../../../oaa/control/ChannelDescriptorData.proto)
- [`AVChannelData.proto`](../../../oaa/av/AVChannelData.proto)
...
- [`InputChannelConfigData.proto`](../../../oaa/input/InputChannelConfigData.proto)
- [`TouchScreenConfigData.proto`](../../../oaa/input/TouchScreenConfigData.proto)
...
- [`display-routing.md`](../../../docs/channels/display-routing.md) — detailed
  16.2 content-routing trace
- [`video.md`](../../../docs/channels/video.md) — AV setup, focus, flow control,
  and video configuration
- [`input.md`](../../../docs/channels/input.md) — display-ID input matching and
  event routing
- [`milestone-04-protocol-correctness.md`](../../../research/archive/openauto-prodigy/docs/plans/milestone-04-protocol-correctness.md)
