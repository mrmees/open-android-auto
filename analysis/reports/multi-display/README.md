...
This directory holds permanent, source-cited research on Android Auto's
multi-display protocol and phone-side rendering architecture.
...
Large APK bundles and decompiled trees remain in ignored version-scoped
directories under `analysis/aa_apk_*`. Each local tree contains its own
`PROVENANCE.md`; the reports here retain the conclusions if those regenerable
