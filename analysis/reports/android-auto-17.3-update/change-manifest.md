...
| CHG-CI-SCHEMA | SVC-CI-SCHEMA | `oaa/carintent/CarIntentMessage.proto`; `oaa/carintent/CarIntentMessage.audit.yaml`; `docs/channels/carintent.md` | Add a proto2 payload containing only optional string field 2 and document its HU -> Phone use. | Field 1, intent-type enum, acknowledgement, and response are forbidden. | `rg -n 'syntax = "proto2"' oaa/carintent/CarIntentMessage.proto && rg -n 'optional string.*= 2' oaa/carintent/CarIntentMessage.proto && ! rg -n '= 1' oaa/carintent/CarIntentMessage.proto && ! rg -n 'enum.*Intent' oaa/carintent/CarIntentMessage.proto && protoc --proto_path=. --cpp_out=/tmp oaa/carintent/CarIntentMessage.proto` | planned (Tasks 12, 13) |
